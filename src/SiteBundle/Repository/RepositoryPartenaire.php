 ...
 */
class RepositoryPartenaire extends LibRepository
{
    /**
    ...
    public function searchAdminList(): Query
    {
        ...
        $dql    = "SELECT {$entity} FROM {$this->bundle}:Partenaire {$entity}";
    ...
    {
        $entity = $this->getEntityName();
        $dql    = "SELECT COUNT({$entity}) AS total FROM {$this->bundle}:Partenaire {$entity}";
        $query  = $this->getQuery($dql);
    ...
    {
        $entity = $this->getEntityName();
        $dql    = "SELECT {$entity} FROM {$this->bundle}:Partenaire {$entity} ORDER BY {$entity}.id desc";
        $query  = $this->getQuery($dql);
