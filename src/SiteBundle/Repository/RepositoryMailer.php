 ...
 */
class RepositoryMailer extends LibRepository
{
    /**
    ...
    public function searchAdminList(): Query
    {
        ...
        $dql    = "SELECT {$entity} FROM {$this->bundle}:Mailer {$entity}";
    ...
    {
        $entity = $this->getEntityName();
        $dql    = "SELECT COUNT({$entity}) AS total FROM {$this->bundle}:Mailer {$entity}";
        $query  = $this->getQuery($dql);
    ...
    {
        $entity = $this->getEntityName();
        $dql    = "SELECT {$entity}.id,{$entity}.subject AS libelle";
        $dql    = "{$dql} FROM {$this->bundle}:Mailer {$entity} ORDER BY {$entity}.id desc";
        $query  = $this->getQuery($dql);
