 ...
 */
class RepositoryBlog extends LibRepository
{
    /**
    ...
    public function searchAdminList(): Query
    {
        ...
        $dql    = "SELECT {$entity} FROM {$this->bundle}:Blog {$entity}";
    ...
    {
        $entity = $this->getEntityName();
        $dql    = "SELECT COUNT({$entity}) AS total FROM {$this->bundle}:Blog {$entity}";
        $query  = $this->getQuery($dql);
    ...
    {
        $entity = $this->getEntityName();
        $dql    = "SELECT {$entity} FROM {$this->bundle}:Blog {$entity} ORDER BY {$entity}.id desc";
        $query  = $this->getQuery($dql);
