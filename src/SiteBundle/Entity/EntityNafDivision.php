...
class EntityNafDivision implements Translatable
{
    /**
     * @var int
     *
     * @ORM\Column(name="nafdivision_id", type="guid")
     * @ORM\Id
     ...
     * @var string
     *
     * @ORM\Column(name="nafdivision_code", type="string", length=255)
     */
    protected $code;
     ...
     * @var string
     * @Gedmo\Translatable
     * @ORM\Column(name="nafdivision_libelle", type="string", length=255)
     */
    protected $libelle; /**
     * @Gedmo\Locale
