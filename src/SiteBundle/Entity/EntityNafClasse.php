...
class EntityNafClasse implements Translatable
{
    /**
     * @var int
     *
     * @ORM\Column(name="nafclasse_id", type="guid")
     * @ORM\Id
     ...
     * @var string
     *
     * @ORM\Column(name="nafclasse_code", type="string", length=255)
     */
    protected $code;
     ...
     * @var string
     * @Gedmo\Translatable
     * @ORM\Column(name="nafclasse_libelle", type="string", length=255)
     */
    protected $libelle;
    /**
     * @Gedmo\Locale
