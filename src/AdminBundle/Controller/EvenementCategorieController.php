...
/**
 * @Route("/evenement/categorie")
 */
class EvenementCategorieController extends LibController
{
    /**
     * @var TableService
     */
    ...
    /**
     * @Route("/", name="admin.evenement.categorie.index")
     *
     * Action index
     *
     * @return Response
    ...
    /**
     * @Route("/form/{id}", name="admin.evenement.categorie.form", defaults={"id": 0})
