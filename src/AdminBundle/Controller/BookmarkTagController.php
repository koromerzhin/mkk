...
/**
 * @Route("/data/bookmark/tag")
 */
class BookmarkTagController extends LibController
{
    /**
     * @var TableService
     */
    ...
    /**
     * @Route("/", name="admin.bookmark.tag.index")
     * Action index
     *
     * @return Response
     */
    ...
    /**
     * @Route("/edit/{id}", name="admin.bookmark.tag.edit", defaults={"id": 0})
    ...
    /**
     * @Route("/delete", name="admin.bookmark.tag.delete")
     *
     * @return JsonResponse
     */
